def recycle(x):
    ...
    print(f'{superunderbar}\"재귀함수가 뭔가요?\"\n{superunderbar}\"재귀함수는 자기 자신을 호출하는 함수라네\"\n{superunderbar}라고 답변하였지.')
    for j in range(x-1, -1, -1):
        minusunderbar = "____" * j
        print(f'{minusunderbar}라고 답변하였지.')
